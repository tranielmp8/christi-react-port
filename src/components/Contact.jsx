...
export default function Contact() {
  return (
    <div id="contact" className="flex flex-col justify-center items-center mt-4 p-1">
        <h1 className="text-[62px] mb-3  ">C O N T A C T</h1>
        <form action="" className="flex flex-col border-4 border-white p-5 rounded-lg">
            ...
            ></textarea>
            <button className="text-2xl text-[#6A7775] bg-white rounded-lg mt-3 transition-all hover:bg-[#6a7775] hover:text-white hover:border-2 hover:border-white" >Submit</button>
        </form>
    </div>
  )
}
