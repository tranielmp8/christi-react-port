      ...
      <div className="hero-container flex   gap-8 mt-3  justify-center">
        ...
        <div className="hero-text flex flex-col mt-7">
          <div className="hero-header">
            <h1
              className="text-[67px] mb-2 text-white 
              text-center font-light hero-head"
            >
              EMPOWERED <br /> TO OVERCOME
            </h1>
            <div className="text-container ">
              <img width={300} src={Img1} alt="Hero text" />
            </div>
          </div>
          <p className="text-[22px] text-white ml-36 text-hero">
            Empowering Women to
            <br />
            Overcome, Restore and Thrive <br />
          </p>
