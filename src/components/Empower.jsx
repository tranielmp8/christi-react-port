...
determination.</p>
                ...
                {/* <button className='empower-btn ml-2 rounded-xl text-2xl hover:border-2 hover:border-white hover:bg-transparent' >empower</button> */}
                </div>
            </div>
